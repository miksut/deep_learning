...
####################################################################################################
# Note: This exercise is based on the paper by Choi et al., 2018 and their proposed StarGAN network 
...
sys.path.insert(0, 'D:\Projects\deep_learning\stargan')
...
# manually preparing portraits for use in pretrained StarGAN
# ------------------------------------------------------------
img_names_in = ['portrait_1.jpg', 'portrait_2.jpg']
img_names_out = []
path_in = 'data/Portrait/'
path_out = 'data/stargan/'
crop_loc = [[0,1700,203,1597], [0,1000,70,890]]
...
# main
# ------------------------------------------------------------
model_save_dir = 'stargan/stargan_celeba_128/models/'
result_dir = 'stargan/stargan_celeba_128/results/'
attributes = [0., 0., 1., 1., 1.] # black hair, blond hair, brown hair, male, young
image_size = 128
...
with torch.no_grad():
	for idx, (img, target_domains) in enumerate(data_loader):
		...
		result_path = os.path.join(result_dir, '{}-images.jpg'.format(idx+1))
